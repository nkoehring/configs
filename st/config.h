 ...
 */
static char font[] = "monofur for powerline-30:antialias=false:autohint=true";
...
static const char *colorname[] = {
	...
	"#3d3e3d", //"#2b2b2b",  //"black",
	"#755a5b", //"#ba9897",  //"red3",
	"#68755a", //"#97ba98",  //"green3",
	"#756e5a", //"#b9ba97",  //"yellow3",
	"#5b6976", //"#9897ba",  //"blue2",
	"#755b76", //"#ba97b9",  //"magenta3",
	"#5b7674", //"#97b9ba",  //"cyan3",
	"#808080", //"#d2d2d2",  //"gray90",
          
	/* 8 bright colors */
	"#5a5b5c", //"#424242",  //"gray50",
	"#a37679", //"#d0b9b9",  //"red",
	"#87a376", //"#b9d0b9",  //"green",
	"#a39b76", //"#d0d0b9",  //"yellow",
	"#758ba3", //"#b9b9d0",  //"#5c5cff",
	"#9f76a3", //"#d0b9d0",  //"magenta",
	"#75a3a1", //"#b9d0d0",  //"cyan",
	"#aeafb0", //"#ffffff",  //"white",
